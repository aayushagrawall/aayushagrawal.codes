...
Drop the `aayushagrawal.codes/` folder into any static host:
- GitHub Pages
...
**Aayush Agrawal**  
AIML Student @ BMS College of Engineering, Bangalore  
[github.com/aayushagrawall](https://github.com/aayushagrawall) · [linkedin.com/in/aayush-agrawall](https://np.linkedin.com/in/aayush-agrawall)
